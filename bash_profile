...
alias s='cd ~/Development/Projects/webs-vagrant-webs-lamp-solr/sites'
...
alias bash_profile_update='curl -sSL https://raw.githubusercontent.com/websNL/bash-profile/master/install.sh | bash'
