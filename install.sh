...
# ---------------------------------------------------------------------------
# Author: Ruben Sartorius <ruben@webs.nl>
# Date: 26 August 2016
...
welcome() {
	echo "Hi developer! I am going to install your new Webs bash profile."
	sleep 2
...
download() {
	curl -sSL https://raw.githubusercontent.com/websNL/bash-profile/master/bash_profile > ${target_file} || fail "Could not download bash_profile"
	sleep 2
